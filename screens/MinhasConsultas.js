      ...
      <View style={styles.consultasKika}>
        ...
        <View style={styles.informacoes}>
          <Pressable
            ...
            style={{ marginLeft: 10, color: "#b5b5b5" }}
          >
            <CheckCircleIcon />
          </Pressable>
          <View style={styles.textContainer1}>
            ...
            <Text style={styles.infos}>Segunda-Feira 27 Agosto</Text>
            <Text style={styles.infos}>Vacinação</Text>
            <Text style={styles.infos}>Status: Em espera...</Text>
          </View>
          <TrashIcon
        ...
        <View style={styles.informacoes}>
          <View style={styles.textContainer2}>
            ...
            <Text style={styles.infos}>Terça-Feira 12 Fevereiro</Text>
            <Text style={styles.infos}>Consulta Rotina</Text>
            <Text style={styles.infos}>Status: Confirmada</Text>
          </View>
        </View>
      </View>
      <View style={styles.consultasRoudy}>
        ...
        <View style={styles.informacoes}>
          <View style={styles.textContainer2}>
            ...
            <Text style={styles.infos}>Segunda-Feira 02 Janeiro</Text>
            <Text style={styles.infos}>Vacinação</Text>
            <Text style={styles.infos}>Status: Concluida</Text>
          </View>
        </View>
      </View>
      <TouchableOpacity
