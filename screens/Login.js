...
export default function Login(){
    ...
    <Pressable style={styles.container}  onPress={Keyboard.dismiss}> 
      ...
      <Text style={{color: "#6FC4CF", position:"relative", right: -50}} onPress={() => navigation.navigate('RecuperacaoPalavraPasse')}>Esqueceu-se da Palavra-passe?</Text>
      <CustomButton text = {"Login"} action={() => navigation.navigate('HomeScreen')}/>
      ...
      <Text style = {{fontSize: 16, color: "#747070"}}>Ainda não tem conta criada? </Text>
      <Pressable
