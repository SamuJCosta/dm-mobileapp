    ...
    <View style={styles.container}>
          ...
          <View style={styles.textoanimais}>
            ...
            <View style={styles.categoriasanimais}>
              <Pressable
                ...
                onPress={() => navigation.navigate("ReceitasAnimal")}
              >
              ...
              <Pressable
                style={styles.categorias}
                onPress={() => navigation.navigate("ConsultasAnimal")}
              >
      ...
      <View style={styles.boxanimais}>
        <View style={styles.bordaanimal}>
          ...
          <View style={styles.textoanimais}>
            <Text style={{ fontSize: 20, fontWeight: 700 }}>Roudy</Text>
            <Text
              style={{
                fontSize: 15,
                color: "#064E57",
